...
/**
 * Precompiled fu-spring-web script plugin.
 **/
public class FuSpringWebPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_FuSpringWeb").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("foo-plugin");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_FuSpringWeb").asSubclass(BasicScript.class);
