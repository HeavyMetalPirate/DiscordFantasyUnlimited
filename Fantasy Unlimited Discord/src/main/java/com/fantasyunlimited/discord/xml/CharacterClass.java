...
public class CharacterClass extends GenericItem {
	...
	public List<Gear> getStartingGear() {
		List<Gear> equip = new ArrayList<>(
				Arrays.asList(ItemUtils.getWeapon(startingMainhand), ItemUtils.getWeapon(startingOffhand),
						ItemUtils.getEquipment(startingHelmet), ItemUtils.getEquipment(startingChest),
						ItemUtils.getEquipment(startingGloves), ItemUtils.getEquipment(startingPants),
						ItemUtils.getEquipment(startingBoots), ItemUtils.getEquipment(startingRing1),
						ItemUtils.getEquipment(startingRing2), ItemUtils.getEquipment(startingNeck)));
